...
def build_cnn_bilstm(hp):
    """CNN-ATT 前端 + 两层 BiLSTM + self-attention。"""
    ...
    cnn_feat = ChannelAttention(bottleneck_units=att_units)(concat)
...
trend_tag = "X13-HP-CNN-BiLSTM_trend"
cycle_tag = "X13-HP-CNN-BiLSTM_cycle"
print("开始 X13-HP-CNN-BiLSTM 趋势项 Hyperband 搜索")
best_trend = tune_component(
    trend_tag, X_trend, y_trend, Xv_trend, yv_trend, TREND_SEARCH
)
print("开始 X13-HP-CNN-BiLSTM 周期项 Hyperband 搜索")
...
result_path = OUTPUT_DIR / f"X13-HP-CNN-BiLSTM_{FORECAST_YEAR}_results.csv"
